...
def verificador(dia, mes=None):
    ...
    if mes not in m:
        ...
        print('Lista de mêses validos abaixo\n')
...
# calculo recebe da função nascimento() o dia e mês do usuario
def calculo(dia, mes):
    m = meses()
    if dia>=20 and dia<=31 and mes==m[0]:
        formatacao(dia, mes, "aries")
    elif dia>=20 and dia<=30 and mes==m[1] or dia>=1 and dia<=20 and mes==m[2]:
    ...
    elif dia>=23 and dia<=31 and mes==m[5] or dia>=1 and dia<=22 and mes==m[6]:
        formatacao(dia, mes, "virgem")
    elif dia>=23 and dia<=30 and mes==m[6] or dia>=1 and dia<=22 and mes==m[7]:
        formatacao(dia, mes, "libra")
    elif dia>=23 and dia<=31 and mes==m[7] or dia>=1 and dia<=22 and mes==m[8]:
        formatacao(dia, mes, "escorpião")
    elif dia>=23 and dia<=30 and mes==m[8] or dia>=1 and dia<=23 and mes==m[9]:
        formatacao(dia, mes, "sagitario")
    elif dia>=23 and dia<=31 and mes==m[9] or dia>=1 and dia<=20 and mes==m[10]:
        formatacao(dia, mes, "capricornio")
    elif dia>=21 and dia<=31 and mes==m[10] or dia>=1 and dia<=19 and mes==m[11]:
        formatacao(dia, mes, "aquario")
    elif dia>=20 and dia<=29 and mes==m[11] or dia>=1 and dia<=19 and mes==m[0]:
